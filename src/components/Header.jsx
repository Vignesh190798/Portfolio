  ...
  return (
    <header
      className={`top-0 w-full z-40 ${
        isScrolled
          ? "sticky backdrop-filter backdrop-blur-lg bg-white bg-opacity-70 shadow-md"
          ...
          <div className="flex flex-1 items-center justify-between gap-8 sm:justify-end">
            <div className="flex gap-4">
              {navItems.map((item, index) => (
                <a
                  key={item.name}
                  href={item.link}
                  className="block shrink-0 rounded-lg bg-white p-2.5 text-gray-600 shadow-lg hover:text-blue-600"
                >
            ...
            >
              ...
              <p className="ms-2 hidden text-left text-xs sm:block">
                <strong className="block font-medium">P Vignesh</strong>
                <a
                  className="text-gray-500 hover:text-blue-600"
                  href="mailto:vigneshp190798@gmail.com"
                >
                  vigneshp190798@gmail.com{" "}
                </a>
              </p>
            </button>
          </div>
